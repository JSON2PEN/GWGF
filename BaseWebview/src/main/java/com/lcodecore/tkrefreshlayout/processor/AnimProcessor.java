...
public class AnimProcessor implements IAnimRefresh, IAnimOverScroll {
    ...
    private int getVisibleHeadHeight() {
        LogUtils.i("header translationY:" + cp.getHeader().getTranslationY() + ",Visible head height:" + (cp.getHeader().getLayoutParams().height + cp.getHeader().getTranslationY()));
        return (int) (cp.getHeader().getLayoutParams().height + cp.getHeader().getTranslationY());
    }

    private int getVisibleFootHeight() {
        LogUtils.i("footer translationY:" + cp.getFooter().getTranslationY() + "");
    ...
    public void animHeadBack(final boolean isFinishRefresh) {
        LogUtils.i("animHeadBack：finishRefresh?->" + isFinishRefresh);
        isAnimHeadBack = true;
    ...
    public void animBottomBack(final boolean isFinishLoading) {
        LogUtils.i("animBottomBack：finishLoading?->" + isFinishLoading);
    ...
    public void animHeadHideByVy(int vy) {
        ...
        isAnimHeadHide = true;
        LogUtils.i("animHeadHideByVy：vy->" + vy);
        vy = Math.abs(vy);
        if (vy < 5000) {
            vy = 8000;
        }
    ...
    public void animBottomHideByVy(int vy) {
        LogUtils.i("animBottomHideByVy：vy->" + vy);
        if (isAnimBottomHide) {
            return;
        }
    ...
    public void animOverScrollTop(float vy, int computeTimes) {
        LogUtils.i("animOverScrollTop：vy->" + vy + ",computeTimes->" + computeTimes);
    ...
    public void animOverScrollBottom(float vy, int computeTimes) {
        LogUtils.i("animOverScrollBottom：vy->" + vy + ",computeTimes->" + computeTimes);
